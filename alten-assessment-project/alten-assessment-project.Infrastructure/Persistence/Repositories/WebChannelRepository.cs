...
namespace alten_assessment_project.Infrastructure.Persistence.Repositories
{
    ...
    public sealed class WebChannelRepository : GenericRepository<WebChannel>, IWebChannelRepository
    {
        public WebChannelRepository(ApplicationDbContext context) : base(context)
        {
        }
    }
